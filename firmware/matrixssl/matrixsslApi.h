...
PSPUBLIC int32	matrixSslNewClientSession(ssl_t **ssl, const sslKeys_t *keys,
...
/*
	Pre-shared Keys
*/
PSPUBLIC int32 matrixSslLoadPsk(sslKeys_t *ssl, const unsigned char *key,
					uint32 keyLen, const unsigned char *id, uint32 idLen);
